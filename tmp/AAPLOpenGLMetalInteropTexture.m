                                     ...
                                     height:(int)height
{
    ...
    if(self) {
        ...
        _width = width;
        _height = height;
        _createOpenGLFBO = createOpenGLFBO;
        _size = size;
...
- (void)createGLTexture
{
    ...
    if (_createOpenGLFBO) {
        ...
        GLuint openGLFBO;
        glGenFramebuffers(1, &openGLFBO);
        glBindFramebuffer(GL_FRAMEBUFFER, openGLFBO);
        glFramebufferTexture2D(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_RECTANGLE, _openGLTexture, 0);
        _openGLFBO = openGLFBO;
