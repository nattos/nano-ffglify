  ...
  functions: [
    ...
    },
    {
      ...
      nodes: [
        ...
        { id: 'c_index', op: 'comment', comment: 'Flat index and 6 clamped neighbor indices for diffusion (computed in float).' },
        { id: 'gx', op: 'vec_swizzle', vec: 'gid_f', channels: 'x' },
        { id: 'gy', op: 'vec_swizzle', vec: 'gid_f', channels: 'y' },
        { id: 'gz', op: 'vec_swizzle', vec: 'gid_f', channels: 'z' },
        { id: 'gz_1024', op: 'math_mul', a: 'gz', b: 1024 },
        { id: 'gy_32', op: 'math_mul', a: 'gy', b: 32 },
        { id: 'gz_gy', op: 'math_add', a: 'gz_1024', b: 'gy_32' },
        { id: 'flat_idx_f', op: 'math_add', a: 'gz_gy', b: 'gx' },
        ...
        { id: 'gx_m1r', op: 'math_sub', a: 'gx', b: 1.0 },
        { id: 'gx_m1', op: 'math_max', a: 'gx_m1r', b: 0.0 },
        { id: 'gx_p1r', op: 'math_add', a: 'gx', b: 1.0 },
        { id: 'gx_p1', op: 'math_min', a: 'gx_p1r', b: 31.0 },
        { id: 'gy_m1r', op: 'math_sub', a: 'gy', b: 1.0 },
        { id: 'gy_m1', op: 'math_max', a: 'gy_m1r', b: 0.0 },
        { id: 'gy_p1r', op: 'math_add', a: 'gy', b: 1.0 },
        { id: 'gy_p1', op: 'math_min', a: 'gy_p1r', b: 31.0 },
        { id: 'gz_m1r', op: 'math_sub', a: 'gz', b: 1.0 },
        { id: 'gz_m1', op: 'math_max', a: 'gz_m1r', b: 0.0 },
        { id: 'gz_p1r', op: 'math_add', a: 'gz', b: 1.0 },
    ...
    },
    {
      ...
      nodes: [
        ...
        { id: 'c_trilin_idx', op: 'comment', comment: 'Swizzle base/next/frac coords, compute 8 flat indices for trilinear corners.' },
        { id: 'bx', op: 'vec_swizzle', vec: 'base_cl', channels: 'x' },
        { id: 'by', op: 'vec_swizzle', vec: 'base_cl', channels: 'y' },
        { id: 'bz', op: 'vec_swizzle', vec: 'base_cl', channels: 'z' },
        { id: 'nx_c', op: 'vec_swizzle', vec: 'next_cl', channels: 'x' },
        { id: 'ny_c', op: 'vec_swizzle', vec: 'next_cl', channels: 'y' },
        { id: 'nz_c', op: 'vec_swizzle', vec: 'next_cl', channels: 'z' },
        { id: 'fx', op: 'vec_swizzle', vec: 'grid_frac', channels: 'x' },
        { id: 'fy', op: 'vec_swizzle', vec: 'grid_frac', channels: 'y' },
        { id: 'fz', op: 'vec_swizzle', vec: 'grid_frac', channels: 'z' },
        { id: 'bz_k', op: 'math_mul', a: 'bz', b: 1024.0 },
        { id: 'nz_k', op: 'math_mul', a: 'nz_c', b: 1024.0 },
        { id: 'by_32', op: 'math_mul', a: 'by', b: 32.0 },
        { id: 'ny_32', op: 'math_mul', a: 'ny_c', b: 32.0 },
        ...
        { id: 'i000f', op: 'math_add', a: 'zy_bb', b: 'bx' },
        { id: 'i000', op: 'static_cast_int', val: 'i000f' },
        { id: 'i100f', op: 'math_add', a: 'zy_bb', b: 'nx_c' },
        { id: 'i100', op: 'static_cast_int', val: 'i100f' },
        { id: 'i010f', op: 'math_add', a: 'zy_bn', b: 'bx' },
        { id: 'i010', op: 'static_cast_int', val: 'i010f' },
        { id: 'i110f', op: 'math_add', a: 'zy_bn', b: 'nx_c' },
        { id: 'i110', op: 'static_cast_int', val: 'i110f' },
        { id: 'i001f', op: 'math_add', a: 'zy_nb', b: 'bx' },
        { id: 'i001', op: 'static_cast_int', val: 'i001f' },
        { id: 'i101f', op: 'math_add', a: 'zy_nb', b: 'nx_c' },
        { id: 'i101', op: 'static_cast_int', val: 'i101f' },
        { id: 'i011f', op: 'math_add', a: 'zy_nn', b: 'bx' },
        { id: 'i011', op: 'static_cast_int', val: 'i011f' },
        { id: 'i111f', op: 'math_add', a: 'zy_nn', b: 'nx_c' },
        ...
        { id: 'cx00', op: 'math_mix', a: 'c000', b: 'c100', t: 'fx' },
        { id: 'cx10', op: 'math_mix', a: 'c010', b: 'c110', t: 'fx' },
        { id: 'cx01', op: 'math_mix', a: 'c001', b: 'c101', t: 'fx' },
        { id: 'cx11', op: 'math_mix', a: 'c011', b: 'c111', t: 'fx' },
        { id: 'cxy0', op: 'math_mix', a: 'cx00', b: 'cx10', t: 'fy' },
        { id: 'cxy1', op: 'math_mix', a: 'cx01', b: 'cx11', t: 'fy' },
        { id: 'd_vol', op: 'math_mix', a: 'cxy0', b: 'cxy1', t: 'fz' },
        ...
        { id: 'qx', op: 'vec_swizzle', vec: 'q_edge', channels: 'x' },
        { id: 'qy', op: 'vec_swizzle', vec: 'q_edge', channels: 'y' },
        { id: 'qz', op: 'vec_swizzle', vec: 'q_edge', channels: 'z' },
        { id: 'qx_pos', op: 'math_max', a: 'qx', b: 0.0 },
        { id: 'qy_pos', op: 'math_max', a: 'qy', b: 0.0 },
        { id: 'qz_pos', op: 'math_max', a: 'qz', b: 0.0 },
        { id: 'q_pos', op: 'float3', x: 'qx_pos', y: 'qy_pos', z: 'qz_pos' },
        { id: 'len_q', op: 'vec_length', a: 'q_pos' },
        { id: 'max_qxy', op: 'math_max', a: 'qx', b: 'qy' },
        { id: 'max_qxyz', op: 'math_max', a: 'max_qxy', b: 'qz' },
