        ...
        functions: [
          {
            ...
            nodes: [
              ...
              { id: 'disp', op: 'cmd_dispatch', func: 'shader_main', threads: [1, 1, 1], args: { f: 'f_val', i: 'i_val', b: 'b_val' } }
            ]
          },
          {
            id: 'shader_main',
        ...
        functions: [
          {
            ...
            nodes: [
              ...
              { id: 'disp', op: 'cmd_dispatch', func: 'shader_main', threads: [1, 1, 1], args: { v2: 'v2', v3: 'v3', v4: 'v4' } }
            ]
          },
          {
            id: 'shader_main',
        ...
        functions: [
          {
            ...
            nodes: [
              ...
              { id: 'disp', op: 'cmd_dispatch', func: 'shader_main', threads: [1, 1, 1], args: { m3: 'm3', m4: 'm4' } }
            ]
          },
          {
            id: 'shader_main',
        ...
        functions: [
          {
            ...
            nodes: [
              ...
              { id: 's', op: 'struct_construct', type: 'Simple', values: { a: 10, b: 'v2' } },
              { id: 'disp', op: 'cmd_dispatch', func: 'shader_main', threads: [1, 1, 1], args: { data: 's' } }
            ]
          },
          {
            id: 'shader_main',
        ...
        functions: [
          {
            ...
            nodes: [
              ...
              { id: 'disp', op: 'cmd_dispatch', func: 'shader_main', threads: [1, 1, 1], args: { data: 'arr' } }
            ]
          },
          {
            id: 'shader_main',
        ...
        functions: [
          {
            ...
            localVars: [],
            nodes: [
              { id: 'p1', op: 'struct_construct', type: 'Point', values: { val: 123 } },
              { id: 'p2', op: 'struct_construct', type: 'Point', values: { val: 456 } },
              { id: 'arr', op: 'array_construct', length: 2, fill: 'p1', next: 'set' },
              { id: 'set', op: 'array_set', array: 'arr', index: 1, value: 'p2', exec_out: 'disp' },
              { id: 'disp', op: 'cmd_dispatch', func: 'shader_main', threads: [1, 1, 1], args: { points: 'arr' } }
            ]
          },
          {
            id: 'shader_main',
        ...
        functions: [
          {
            ...
            nodes: [
              ...
              { id: 'disp', op: 'cmd_dispatch', func: 'shader_main', threads: [1, 1, 1], args: { msg: 'str' } }
            ]
          },
          {
            id: 'shader_main',
