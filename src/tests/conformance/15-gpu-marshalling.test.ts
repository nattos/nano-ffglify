...
import { runFullGraphTest, runFullGraphErrorTest, availableBackends } from './test-runner';
import { IRDocument } from '../../ir/types';

// Filter out Compute backend as it doesn't test marshalling logic
...
describe('Conformance: GPU Marshalling', () => {
      ...
      functions: [
        ...
        },
        {
          ...
          nodes: [
            ...
            { id: 's9', op: 'buffer_store', buffer: 'b_res', index: 9, value: 'm4_0' },
            { id: 's14', op: 'buffer_store', buffer: 'b_res', index: 14, value: 'm4_5' },
            { id: 's19', op: 'buffer_store', buffer: 'b_res', index: 19, value: 'm4_10' },
            { id: 's24', op: 'buffer_store', buffer: 'b_res', index: 24, value: 'm4_15' }
          ],
          edges: []
        }
      ]
      ...
      functions: [
        {
          ...
          nodes: [
            ...
            { id: 'arr', op: 'array_construct', length: 2, fill: 'p1' },
            { id: 'set', op: 'array_set', array: 'arr', index: 1, value: 'p2' },
            { id: 'disp', op: 'cmd_dispatch', func: 'shader_main', dispatch: [1, 1, 1], points: 'arr' }
          ],
          edges: [
            { from: 'set', portOut: 'exec_out', to: 'disp', portIn: 'exec_in', type: 'execution' }
          ]
        },
        {
          id: 'shader_main',
  ...
  // Atomics (TODO)
  // ----------------------------------------------------------------
  // TODO: Add tests for atomic operations marshalling
